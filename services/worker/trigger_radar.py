...
# Parameters
AOI_ID = "98fd8eb9-3d20-4180-ab4b-0e5272e20076" # Use the known valid AOI
...
# Target Week (Recent one to ensure data exists)
YEAR = 2025
WEEK = 40 
...
if row:
    ...
    # Need to access the high queue URL from the initialized client
    # Since we can't easily pass it in SendMessage in this script without modifying SQSClient call,
    # let's assume we update the script to use the internal client property if public, 
    # or better: SQSClient.send_message(..., queue_url=sqs.queue_high_url)
...
# Monitor S3/Logs manually after this
