...
Implements SatelliteDataProvider using Microsoft Planetary Computer.
"""
...
class PlanetaryComputerProvider(SatelliteDataProvider):
    ...
    Collections: sentinel-2-l2a, sentinel-1-rtc, copernicus-dem-glo-30
    Authentication: SAS tokens via planetary_computer.sign().
    """
    ...
    def sign_url(self, href: str) -> str:
        try:
            ...
            logger.warning("pc_signing_failed_fallback", error=str(exc))
            return href
