...
function AuditContent({ token }: { token: string }) {
    ...
    return (
        <div className="mx-auto max-w-7xl space-y-6">
            <div>
                <p className="text-sm text-muted-foreground">Monitoramento centralizado de eventos administrativos.</p>
                <h2 className="text-2xl font-semibold text-foreground">Audit Log Global</h2>
            </div>
...
export default function AdminAuditPage() {
    return (
        <AdminAuthGate>
            {(token) => <AuditContent token={token} />}
        </AdminAuthGate>
    )
}
