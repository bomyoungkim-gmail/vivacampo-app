"""
CDSE (Copernicus Data Space Ecosystem) STAC provider.
"""
...
class CDSEProvider(SatelliteDataProvider):
    """Copernicus Data Space Ecosystem STAC provider."""
    ...
    def __init__(self, client_id: Optional[str] = None, client_secret: Optional[str] = None, catalog_url: Optional[str] = None):
